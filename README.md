...
This is a setup to run and join the merge devnets, testnets, and mainnet too! with a single shell command. This script will pull the appropriate images and config and spin up the EL client and lodestar.
